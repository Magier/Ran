...
/// hits EOF. Session health is published independently by the shell's transport
/// monitor; this text describes the action failure only.
pub const SESSION_CLOSED_UNEXPECTEDLY: &str = "shell session closed unexpectedly";
pub const DEFAULT_EXECUTION_TIMEOUT_SECONDS: u64 = 150;
