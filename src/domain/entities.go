...
type SystemImpl struct {
	...
	accessLevelExplicit bool              // set to true when AccessLevel was explicitly assigned via SetAccessLevel
...
func (s *SystemImpl) SetUserID(uid int) {
	s.UserID = uid
}
